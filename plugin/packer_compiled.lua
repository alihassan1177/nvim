...
_G.packer_plugins = {
  ...
  gruvbox = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/nvim-transparent",
  ...
  ["vim-nightfly-guicolors"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/vim-nightfly-guicolors",
    url = "https://github.com/bluz71/vim-nightfly-guicolors"
  },
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
